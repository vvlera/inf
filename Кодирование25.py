...
def InfC():
    ...
    while workIn == True:
        ...
        if formIn == '1':
            find = input('\n Что ищем: 1: N (мощность алфавита) или 2: i (разрядность двоичного кода)?: ')
            if find == '1':
            ...
            find = input('\nЧто ищем: 1: I (информационный объём текста), 2: k (кол-во символов) или 3: i (информационный вес одного символа)?: ')
            if find == '1':
...
def SoC():
    ...
    while workSo == True:
        ...
        if formSo == '1':
            find = input('\nЧто ищем: 1: H (частоту дискретизации) или 2: T (шаг дискретизации)?: ')
            if find == '1':
            ...
            find = input('\nЧто ищем: 1: I (объём звуковой информации), 2: R (количество каналов), 3: H (частоту дискретизации), 4: t (время записи) или 5: b (глубину кодирования/разрядность квантования)?: ')
            if find == '1':
...
def ImC():
    ...
    while workIm == True:
        ...
        if formIm == '1':
            find = input('\nЧто ищем: 1: N количество цветов (N) или 2: разрядность двоичного кода (i)?: ')
            if find == '1':
